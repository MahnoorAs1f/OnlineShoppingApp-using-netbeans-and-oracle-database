...
public class ProductManagementMenu extends JFrame {
    ...
    public ProductManagementMenu() {
        ...
        removeButton = createStyledButton("Remove Product");
        ...
        viewButton.addActionListener(e -> {
            new DisplayProductPanel().setVisible(true);
            dispose();
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ProductManagementMenu().setVisible(true));
    }
}
